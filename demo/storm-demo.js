...
(function () {
  ...
  function freshState(){
    return {
      uiLang:'fr',contentLang:'fr',projectName:'',logoUrl:'',
  ...
  const UI = {
    fr: {
      ...
      interfaceTitle:'Dans quelle langue souhaitez-vous utiliser Storm ?',
      interfaceSub:'Cette langue concerne uniquement votre console Storm.',
      ...
      securityTitle:'Sécurisez votre espace.', securitySub:'Créez le mot de passe administrateur de ce projet. Il pourra être modifié plus tard.', password:'Mot de passe administrateur', passwordConfirm:'Confirmer le mot de passe', passwordHint:'8 caractères minimum', passwordMismatch:'Les deux mots de passe doivent être identiques.',
      accessTitle:'Qui peut contribuer ?', accessSub:'Vous êtes administrateur. Vous pourrez aussi donner des accès à d’autres personnes, avec un niveau adapté à leur rôle.', accessAdmin:'Administrateur', accessAdminDesc:'Tout gérer : identité, accès, contenus et publication.', accessEditor:'Éditeur', accessEditorDesc:'Créer, modifier et publier les contenus.', accessContributor:'Contributeur', accessContributorDesc:'Créer et modifier des contenus, sans pouvoir publier.', inviteTitle:'Donner un accès', inviteEmail:'Adresse e-mail', inviteRole:'Niveau d’accès', inviteAdd:'Ajouter', inviteLater:'Plus tard', inviteAdded:'Accès préparé',
    ...
    en: {
      ...
      interfaceTitle:'Which language would you like to use Storm in?', interfaceSub:'This language only applies to your Storm console.',
      ...
      securityTitle:'Secure your space.', securitySub:'Create the administrator password for this project. It can be changed later.', password:'Administrator password', passwordConfirm:'Confirm password', passwordHint:'8 characters minimum', passwordMismatch:'Both passwords must match.',
      accessTitle:'Who can contribute?', accessSub:'You are the administrator. You can also give other people access with a level that matches their role.', accessAdmin:'Administrator', accessAdminDesc:'Manage everything: identity, access, content and publishing.', accessEditor:'Editor', accessEditorDesc:'Create, edit and publish content.', accessContributor:'Contributor', accessContributorDesc:'Create and edit content without publishing.', inviteTitle:'Give access', inviteEmail:'Email address', inviteRole:'Access level', inviteAdd:'Add', inviteLater:'Later', inviteAdded:'Access prepared',
    ...
    it: {
      ...
      interfaceTitle:'In quale lingua vuoi usare Storm?', interfaceSub:'Questa lingua riguarda solo la tua console Storm.',
      ...
      securityTitle:'Proteggi il tuo spazio.', securitySub:'Crea la password amministratore di questo progetto. Potrai modificarla in seguito.', password:'Password amministratore', passwordConfirm:'Conferma la password', passwordHint:'Almeno 8 caratteri', passwordMismatch:'Le due password devono essere identiche.',
      accessTitle:'Chi può contribuire?', accessSub:'Sei amministratore. Puoi anche dare accesso ad altre persone con un livello adatto al loro ruolo.', accessAdmin:'Amministratore', accessAdminDesc:'Gestire tutto: identità, accessi, contenuti e pubblicazione.', accessEditor:'Editor', accessEditorDesc:'Creare, modificare e pubblicare contenuti.', accessContributor:'Contributore', accessContributorDesc:'Creare e modificare contenuti senza pubblicare.', inviteTitle:'Dare accesso', inviteEmail:'Indirizzo e-mail', inviteRole:'Livello di accesso', inviteAdd:'Aggiungi', inviteLater:'Più tardi', inviteAdded:'Accesso preparato',
    ...
    es: {
      ...
      interfaceTitle:'¿En qué idioma quieres usar Storm?', interfaceSub:'Este idioma solo se aplica a tu consola Storm.',
      ...
      securityTitle:'Protege tu espacio.', securitySub:'Crea la contraseña de administrador de este proyecto. Podrás modificarla más adelante.', password:'Contraseña de administrador', passwordConfirm:'Confirmar contraseña', passwordHint:'8 caracteres como mínimo', passwordMismatch:'Las dos contraseñas deben coincidir.',
      accessTitle:'¿Quién puede contribuir?', accessSub:'Eres administrador. También podrás dar acceso a otras personas con un nivel adaptado a su función.', accessAdmin:'Administrador', accessAdminDesc:'Gestionarlo todo: identidad, accesos, contenidos y publicación.', accessEditor:'Editor', accessEditorDesc:'Crear, modificar y publicar contenidos.', accessContributor:'Colaborador', accessContributorDesc:'Crear y modificar contenidos sin publicar.', inviteTitle:'Dar acceso', inviteEmail:'Correo electrónico', inviteRole:'Nivel de acceso', inviteAdd:'Añadir', inviteLater:'Más tarde', inviteAdded:'Acceso preparado',
    ...
    nl: {
      ...
      interfaceTitle:'In welke taal wil je Storm gebruiken?', interfaceSub:'Deze taal geldt alleen voor je Storm-console.',
      ...
      securityTitle:'Beveilig je ruimte.', securitySub:'Maak het beheerderswachtwoord voor dit project. Je kunt het later wijzigen.', password:'Beheerderswachtwoord', passwordConfirm:'Wachtwoord bevestigen', passwordHint:'Minimaal 8 tekens', passwordMismatch:'Beide wachtwoorden moeten hetzelfde zijn.',
      accessTitle:'Wie kan bijdragen?', accessSub:'Jij bent beheerder. Je kunt ook anderen toegang geven met een niveau dat bij hun rol past.', accessAdmin:'Beheerder', accessAdminDesc:'Alles beheren: identiteit, toegang, content en publicatie.', accessEditor:'Editor', accessEditorDesc:'Content maken, bewerken en publiceren.', accessContributor:'Bijdrager', accessContributorDesc:'Content maken en bewerken zonder te publiceren.', inviteTitle:'Toegang geven', inviteEmail:'E-mailadres', inviteRole:'Toegangsniveau', inviteAdd:'Toevoegen', inviteLater:'Later', inviteAdded:'Toegang voorbereid',
    ...
    de: {
      ...
      interfaceTitle:'In welcher Sprache möchten Sie Storm verwenden?', interfaceSub:'Diese Sprache gilt nur für Ihre Storm-Konsole.',
      ...
      securityTitle:'Sichern Sie Ihren Bereich.', securitySub:'Erstellen Sie das Administrator-Passwort für dieses Projekt. Es kann später geändert werden.', password:'Administrator-Passwort', passwordConfirm:'Passwort bestätigen', passwordHint:'Mindestens 8 Zeichen', passwordMismatch:'Beide Passwörter müssen übereinstimmen.',
      accessTitle:'Wer kann mitarbeiten?', accessSub:'Sie sind Administrator. Sie können auch anderen Personen Zugriff mit einer passenden Berechtigungsstufe geben.', accessAdmin:'Administrator', accessAdminDesc:'Alles verwalten: Identität, Zugriffe, Inhalte und Veröffentlichung.', accessEditor:'Editor', accessEditorDesc:'Inhalte erstellen, bearbeiten und veröffentlichen.', accessContributor:'Mitwirkender', accessContributorDesc:'Inhalte erstellen und bearbeiten, ohne zu veröffentlichen.', inviteTitle:'Zugriff geben', inviteEmail:'E-Mail-Adresse', inviteRole:'Zugriffsstufe', inviteAdd:'Hinzufügen', inviteLater:'Später', inviteAdded:'Zugriff vorbereitet',
  ...
  function buildRoot(){
    ...
    node.innerHTML=`
      ...
      <section class="storm-scene storm-modules-scene" data-scene="modules" hidden>
        ${topbarMarkup('theme')}${setupProgressMarkup(6,8)}
      ...
      <section class="storm-scene" data-scene="security" hidden>
        ${topbarMarkup('modules')}${setupProgressMarkup(7,8)}
        <div class="storm-step-inner storm-security-inner">
          <h1 class="storm-title small" id="stormSecurityTitle"></h1>
          <p class="storm-subtitle" id="stormSecuritySub"></p>
          <div class="storm-security-form">
            <label class="storm-security-field">
              <span id="stormPasswordLabel"></span>
              <div class="storm-password-row">
                <input type="password" id="stormPassword" autocomplete="new-password">
                <button type="button" class="storm-password-toggle" data-password-toggle="stormPassword">Afficher</button>
              </div>
            </label>
            <label class="storm-security-field">
              <span id="stormPasswordConfirmLabel"></span>
              <div class="storm-password-row">
                <input type="password" id="stormPasswordConfirm" autocomplete="new-password">
                <button type="button" class="storm-password-toggle" data-password-toggle="stormPasswordConfirm">Afficher</button>
              </div>
            </label>
            <div class="storm-password-feedback"><span id="stormPasswordHint"></span><strong id="stormPasswordError"></strong></div>
          </div>
          <div class="storm-continue-row"><span></span><button class="storm-btn-primary" id="stormSecurityContinue" disabled></button></div>
        </div>
      </section>

      <section class="storm-scene storm-access-scene" data-scene="access" hidden>
        ${topbarMarkup('security')}${setupProgressMarkup(8,8)}
  ...
  function applyTexts(){
    ...
    [['stormUiLangTitle','interfaceTitle'],['stormUiLangSub','interfaceSub'],['stormUiLangContinue','continue'],
     ...
     ['stormSecurityTitle','securityTitle'],['stormSecuritySub','securitySub'],['stormPasswordLabel','password'],['stormPasswordConfirmLabel','passwordConfirm'],['stormPasswordHint','passwordHint'],['stormSecurityContinue','continue'],
    ...
    if(inviteRole){
      ...
      inviteRole.options[2].text=s.accessAdmin;
    }
    root.querySelectorAll('.storm-password-toggle').forEach(btn=>btn.textContent='Afficher');
  ...
  function validatePasswordStep(){
    const p=root.querySelector('#stormPassword')?.value||'';
    const c=root.querySelector('#stormPasswordConfirm')?.value||'';
    const error=root.querySelector('#stormPasswordError');
    const button=root.querySelector('#stormSecurityContinue');
    const longEnough=p.length>=8;
    const matches=p===c && c.length>0;
    if(error) error.textContent=(c.length>0&&!matches)?t().passwordMismatch:'';
    if(button) button.disabled=!(longEnough&&matches);
    if(longEnough&&matches) state.adminPassword=p;
  }

  async function showSecurity(){
    applyTexts();
    const p=root.querySelector('#stormPassword'),c=root.querySelector('#stormPasswordConfirm');
    p.value=state.adminPassword||'';c.value=state.adminPassword||'';
    validatePasswordStep();
    await transitionTo('security');
    p.focus();
  }
  ...
  function accessLevelCardsHtml(){
    const s=t();
    return [
      ['admin',s.accessAdmin,s.accessAdminDesc],
  ...
  function renderInviteList(){
    ...
    const roleLabel={admin:s.accessAdmin,editor:s.accessEditor,contributor:s.accessContributor};
    wrap.innerHTML=state.invites.map((invite,index)=>`<div class="storm-invite-chip"><span>${escapeHtml(invite.email)}</span><small>${escapeHtml(roleLabel[invite.role]||invite.role)}</small><button type="button" data-remove-invite="${index}" aria-label="Retirer">×</button></div>`).join('');
  ...
  function bindSetupInteractions(node){
    ...
    function useLogo(file){if(!file||!file.type.startsWith('image/'))return;if(logoObjectUrl)URL.revokeObjectURL(logoObjectUrl);logoObjectUrl=URL.createObjectURL(file);state.logoUrl=logoObjectUrl;refreshLogoPreview();}
    ...
    ['stormPassword','stormPasswordConfirm'].forEach(id=>node.querySelector('#'+id).addEventListener('input',validatePasswordStep));
    node.querySelectorAll('[data-password-toggle]').forEach(btn=>btn.addEventListener('click',()=>{
      const input=node.querySelector('#'+btn.dataset.passwordToggle);
      const reveal=input.type==='password';input.type=reveal?'text':'password';btn.textContent=reveal?'Masquer':'Afficher';
    }));

    node.querySelector('#stormInviteAdd').addEventListener('click',()=>{
      const email=node.querySelector('#stormInviteEmail').value.trim();
      const role=node.querySelector('#stormInviteRole').value;
  ...
  function preparePublicHomepage(){
    ...
    document.querySelector('.nav-tab[data-page="faq"]')?.classList.add('active');
    window.scrollTo({top:0,behavior:'auto'});
  }

  async function revealPublicHomepage(){
    preparePublicHomepage();
    document.dispatchEvent(new CustomEvent('storm:onboarding-complete',{detail:{projectName:state.projectName,theme:state.theme,uiLang:state.uiLang,contentLang:state.contentLang}}));
    await animate(root,[{opacity:1,transform:'scale(1)'},{opacity:0,transform:'scale(1.003)'}],{duration:480,easing:'cubic-bezier(.4,0,1,1)'});
    cleanup(false);
  }
  ...
  function bindGlobalNavigation(node){
    ...
    node.querySelector('#stormModulesContinue').addEventListener('click',showSecurity);
    node.querySelector('#stormSecurityContinue').addEventListener('click',showAccess);
    ...
    node.querySelectorAll('[data-back]').forEach(btn=>btn.addEventListener('click',()=>{
      const routes={'ui-language':showUiLanguage,'content-language':showContentLanguage,'welcome':showWelcome,'project':showProject,'logo':showLogo,'colors':showColors,'fonts':showFonts,'theme':showTheme,'modules':showModules,'security':showSecurity,'access':showAccess};
  ...
  function close(){if(root)cleanup();}
  function handleKeydown(e){if(e.key==='Escape'){e.preventDefault();close();}}
  function shouldAutoOpen(){return new URLSearchParams(location.search).get('stormDemo')==='1';}
  function init(){
    document.getElementById('stormDemoLaunchBtn')?.addEventListener('click',open);
    document.addEventListener('keydown',e=>{if(e.altKey&&e.key.toLowerCase()==='d')open();});
    window.StormShowcase=Object.freeze({play:open,close});
    if(shouldAutoOpen())setTimeout(open,120);
  }
